package com.playtech.librioniq.config;

import com.playtech.librioniq.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.playtech.librioniq.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.playtech.librioniq.repository.search")
