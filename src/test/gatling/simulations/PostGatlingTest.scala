...
class PostGatlingTest extends Simulation {
    ...
    val headers_http = Map(
        ...
        val authorization_header = "Basic " + Base64.getEncoder.encodeToString("Librioniqapp:mySecretOAuthSecret".getBytes(StandardCharsets.UTF_8))
    ...
    val scn = scenario("Test the Post entity")
        ...
        .formParam("client_id", "Librioniqapp")
        ...
        .repeat(2) {
            ...
            .post("/api/posts")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "content":"SAMPLE_TEXT", "type":"0"}""")).asJSON
            .check(status.is(201))
